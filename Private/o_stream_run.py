...
#aScanListNames = ["AIN0", "AIN1", "AIN2", "AIN3"] #Scan list names to stream in and out
...
try:
    ...
    while i <= MAX_REQUESTS:
        ...
        #Note that the Python eStreamData currently will return a data list of
        #size scansPerRead*TOTAL_NUM_CHANNELS, but only the first
