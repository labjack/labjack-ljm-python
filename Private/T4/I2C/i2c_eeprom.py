...
a LJTick-DAC connected to FIO4/FIO5, configures I2C settings, and reads, writes
...
sda = 5  # SDA pin number = 5 (FIO5)
scl = 4  # SCL pin number = 4 (FIO4)

# Configure the I2C communication.
ljm.eWriteName(handle, "I2C_SDA_DIONUM", sda)
ljm.eWriteName(handle, "I2C_SCL_DIONUM", scl)
